    ...
    <div className={`relative ${className}`} ref={searchRef}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-12 pr-4 py-3 border border-sage-200 dark:border-sage-700 rounded-xl bg-white dark:bg-neutral-800 text-sage-900 dark:text-sage-100 placeholder-sage-500 dark:placeholder-sage-400 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:border-transparent transition-all duration-200"
        ...
        {searchTerm && (
          <button
            ...
            className="absolute inset-y-0 right-0 pr-4 flex items-center text-sage-400 hover:text-sage-600 dark:hover:text-sage-300"
          >
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2 mb-1">
                        <h4 className="font-medium text-sage-900 dark:text-sage-100 truncate">
                          {book.title}
                        </h4>
                        {book.isbn && (
