...
const BookCard = ({ book, onViewDetails, onBorrow, className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-rows-[auto_1fr_auto] h-full p-4 sm:p-6">
        ...
        <div className="flex justify-between space-y-3 min-h-0">
          <div>
            ...
            {book.isbn && (
              <p className="text-xs text-sage-500 dark:text-sage-500 font-mono leading-relaxed">
                <span className="line-clamp-1 block">ISBN: {book.isbn}</span>
              </p>
            )}
