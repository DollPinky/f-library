  ...
  const bookColumns = useMemo(
      () => [
        ...
        },
        {
          ...
          header: "Tác giả",
          render: (value) => (
              <div className="text-sage-600 dark:text-sage-400 text-responsive-small">{value || "N/A"}</div>
          ),
        },
        {
          key: "category",
          ...
          <div className="container-responsive">
            ...
            <div className="grid-responsive mb-6 sm:mb-8">
              ...
              <StatisticCard
                  ...
                  value={dashboardStats?.totalBorrowings || 0}
                  change="+5.7%"
                  changeType="positive"
                  ...
                  <Link href="/librarian" className="group">
                    <div className="p-4 bg-sage-50 dark:bg-sage-800 rounded-xl border border-sage-200 dark:border-sage-700 hover:bg-sage-100 dark:hover:bg-sage-700 transition-all duration-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-medium text-sage-900 dark:text-sage-100">Quản lý mượn sách</h3>
                  ...
                  <Link href="/books" className="group">
                    <div className="p-4 bg-sage-50 dark:bg-sage-800 rounded-xl border border-sage-200 dark:border-sage-700 hover:bg-sage-100 dark:hover:bg-sage-700 transition-all duration-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-medium text-sage-900 dark:text-sage-100">Khám phá sách</h3>
                  ...
                  <div className="group cursor-pointer" onClick={refreshData}>
                    <div className="p-4 bg-sage-50 dark:bg-sage-800 rounded-xl border border-sage-200 dark:border-sage-700 hover:bg-sage-100 dark:hover:bg-sage-700 transition-all duration-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-medium text-sage-900 dark:text-sage-100">Làm mới dữ liệu</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sage-900 dark:text-sage-100">{selectedBook.category?.name || "Chưa phân loại"}</p>
                    </div>
                    <div>
