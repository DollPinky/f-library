    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (message.includes("Mật khẩu")) {
          ...
          toast.error("Tài khoản hoặc mật khẩu không chính xác");
        } else if (message.includes("kết nối")) {
    ...
    <Card className="w-full max-w-md shadow-2xl">
      <CardHeader className="space-y-3 text-center pb-4">
        <div className="flex justify-center">
          <div className="p-3 bg-gradient-to-br rounded-full shadow-lg">
            <img
              src={logoImage}
      ...
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full h-11 text-sm font-semibold bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 transition-all"
        ...
        <div className="pt-4 border-t border-gray-200">
          <p className="text-center text-xs text-gray-500">
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                toast.info("Vui lòng liên hệ quản trị viên");
              }}
            >
              Sign up
            </a>
